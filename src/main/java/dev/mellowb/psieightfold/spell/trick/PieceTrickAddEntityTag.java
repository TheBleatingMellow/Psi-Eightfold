...
public final class PieceTrickAddEntityTag extends PieceTrick {
    SpellParam<?> entity;
    SpellParam<?> text;
    public PieceTrickAddEntityTag(Spell spell) { super(spell); }
    ...
    @Override public Object execute(SpellContext context) throws SpellRuntimeException {
        try {
            ReflectOps.addTag(getNotNullParamValue(context, entity), (String)getNotNullParamValue(context, text));
            return null;
        } catch (Throwable e) {
